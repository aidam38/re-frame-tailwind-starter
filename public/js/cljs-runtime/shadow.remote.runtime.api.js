...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31967 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31967(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31980 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31980(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32000 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32000(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32014 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32014(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32041 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32041(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32050 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32050(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31797,callback){
var map__31800 = p__31797;
var map__31800__$1 = cljs.core.__destructure_map(map__31800);
var input = map__31800__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31800__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31800__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
