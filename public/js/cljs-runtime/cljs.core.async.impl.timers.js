...
var i_30739 = (0);
while(true){
if((i_30739 < arr.length)){
(arr[i_30739] = null);

var G__30740 = (i_30739 + (1));
i_30739 = G__30740;
continue;
} else {
}
...
var i_30748 = (self__.level + (1));
while(true){
if((i_30748 <= (new_level + (1)))){
(update[i_30748] = self__.header);

var G__30749 = (i_30748 + (1));
i_30748 = G__30749;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30750 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30750[i]));
} else {
x__$2.forward.push((((i < links_30750.length))?(links_30750[i]):null));
}

if((i < links_30750.length)){
(links_30750[i] = x__$2);
} else {
links_30750.push(x__$2);
}
...
var i_30752 = (0);
while(true){
if((i_30752 <= self__.level)){
var links_30753 = (update[i_30752]).forward;
if((x__$1 === (((i_30752 < links_30753.length))?(links_30753[i_30752]):null))){
(links_30753[i_30752] = (x__$1.forward[i_30752]));

var G__30754 = (i_30752 + (1));
i_30752 = G__30754;
continue;
} else {
var G__30755 = (i_30752 + (1));
i_30752 = G__30755;
continue;
}
} else {
...
var G__30757 = nx;
var G__30758 = (level__$1 - (1));
x = G__30757;
level__$1 = G__30758;
continue;
} else {
var G__30759 = x;
var G__30760 = (level__$1 - (1));
x = G__30759;
level__$1 = G__30760;
continue;
}
