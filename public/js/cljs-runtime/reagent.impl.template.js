...
var G__36968 = o;
goog.object.set(G__36968,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36969 = o;
goog.object.set(G__36969,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36992__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36993__i < G__36993__a.length) {G__36993__a[G__36993__i] = arguments[G__36993__i + 0]; ++G__36993__i;}
  args = new cljs.core.IndexedSeq(G__36993__a,0,null);
} 
return G__36992__delegate.call(this,args);};
G__36992.cljs$lang$maxFixedArity = 0;
G__36992.cljs$lang$applyTo = (function (arglist__36994){
var args = cljs.core.seq(arglist__36994);
return G__36992__delegate(args);
});
...
var G__36973 = props;
var G__36973__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36973,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36973);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36973__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36974 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36974,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36974;
}
})(),id_class);
...
var G__36975 = (cljs.core.count(argv) - first_child);
switch (G__36975) {
case (0):
...
var vec__36976 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36976,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36976,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36976,(2),null);
...
var temp__5757__auto___36999 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36999 == null)){
} else {
var key_37000 = temp__5757__auto___36999;
...
var temp__5757__auto___37002 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37002 == null)){
} else {
var key_37003 = temp__5757__auto___37002;
(jsprops.key = key_37003);
}
...
var temp__5757__auto___37004 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37004 == null)){
} else {
var key_37005 = temp__5757__auto___37004;
(jsprops.key = key_37005);
}
...
var temp__5757__auto___37007 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37007 == null)){
} else {
var key_37008 = temp__5757__auto___37007;
(jsprops.key = key_37008);
}
...
var temp__5757__auto___37009 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37009 == null)){
} else {
var key_37010 = temp__5757__auto___37009;
(jsprops.key = key_37010);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36979_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36979_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36980 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36980,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36980,(1),null);
...
break;
default:
var G__37013 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37014 = compiler;
v = G__37013;
compiler = G__37014;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36986 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36986 = (function (opts,id,fn_to_element,parse_fn,meta36987){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36986.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36988,meta36987__$1){
var self__ = this;
var _36988__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36986(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta36987__$1));
}));

(reagent.impl.template.t_reagent$impl$template36986.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36988){
var self__ = this;
var _36988__$1 = this;
return self__.meta36987;
}));

(reagent.impl.template.t_reagent$impl$template36986.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36986.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36986.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template36986.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36986.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36986.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta36987","meta36987",157560518,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36986.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36986.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36986");

(reagent.impl.template.t_reagent$impl$template36986.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template36986");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36986.
 */
reagent.impl.template.__GT_t_reagent$impl$template36986 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36986(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36987){
return (new reagent.impl.template.t_reagent$impl$template36986(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36987));
});

}

return (new reagent.impl.template.t_reagent$impl$template36986(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
